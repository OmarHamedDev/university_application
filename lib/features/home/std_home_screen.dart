...
import 'package:hti_university_app_1/features/home/std_home_tabs/notification/notification_tab.dart';
import 'package:hti_university_app_1/features/presentation/home/st_home/st_request/view/requests_tab.dart';

import '../../core/api/addition/serviceApi.dart';
import '../../core/utils/constants/App_colors.dart';
import '../data/repositories_impl/notification_repo_imp.dart';
...
class _StdHomeScreenState extends State<StdHomeScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(create: (context) => NotificationCubit(NotificationRepoImp(ServiceAPIs(Dio())))..notification(),
      child: Scaffold(

...
import '../view_model/student_profile_cubit.dart';
...
class _StudentProfileState extends State<StudentProfile> {
  var profileCubit = getIt.get<StudentProfileCubit>();
  @override
  void initState() {
      ...
      child: Scaffold(
        ...
        body: BlocConsumer<StudentProfileCubit, StudentProfileState>(
          listener: (context, state) {
            if (state is DeleteStudentProfileLoading) {
              LoadingDialog.showLoadingDialog(context);
            }
            if (state is UpdateStudentProfileLoading) {
              LoadingDialog.showLoadingDialog(context);
            } else if (state is DeleteStudentProfileSuccess) {
            ...
            } else if (state is DeleteStudentProfileError) {
              LoadingDialog.hideLoadingDialog(context);
              showAwesomeDialog(
                context,
                title: "Error",
            ...
            } else if (state is UpdateStudentProfileError) {
              LoadingDialog.hideLoadingDialog(context);
              showAwesomeDialog(
                context,
                title: "Error",
          ...
          builder: (context, state) {
            if (state is GetStudentProfileLoading) {
              return HandleState.loading();
            } else if (state is GetStudentProfileError) {
